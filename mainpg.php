    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="moneydonaton.php">Money Donation</a>
        </div>
      </li>
      <div>
      <a class= "" href="addtomainpg.php">
  <button class="btn btn-primary float-right">Activities</button></a>
      </div>
    </ul>
  </div>
...
<?php 
  ...
  ?>
  <a class= "" href="chatpg.php">
  <button class="btn btn-primary float-right">CHAT</button></a>
