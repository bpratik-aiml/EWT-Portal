...
<body>
    ...
    <form class="was-validated" action="demo.php" method="post" method="post">
        <div class="container">
                ...
                <div id="input-type" class="row">
                    <div class="col-sm-6">
                        <label class="radio-inline">
                            <input name="gender_type_male" id="input-type-male" value="Male" type="radio" />Male
                        </label>
                    </div>
                    <div class="col-sm-6">
                        <label class="radio-inline">
                            <input name="gender_type_female" id="input-type-female" value="Female" type="radio" />Female
                        </label>
                    </div>
                </div>
            </div>
            ...
            <br><center><button id="submit" class="btn btn-primary" type="submit">Submit</button></center>
        </div>
        <br> <br> <br> <br> <br>
    </form>
        <footer>
